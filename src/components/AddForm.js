...
export default function AddForm({ item }) {
    ...
    const onSubmit = () => {
        ...
        if (init) return false;
            ...
            if (item) {
                dispatch(actionCreaters.editPost({
                    uri: image,
                    title,
                    city,
                    country,
                ...
                dispatch(actionCreaters.addPost({
                    uri: image,
                    title,
                    city,
                    country,
    ...
    const deletePost = () => {
        dispatch(actionCreaters.deletePost(item.key));
        navigation.navigate('Post');
    }
        ...
        <View style={styles.container} >
            ...
            />
            {
                ...
                <Button
                    ...
                    onPress={deletePost}
                    titleStyle={{ letterSpacing: 1, marginLeft: 10, fontSize: 20}}
                    buttonStyle={[styles.finishButton, { backgroundColor: 'salmon' }]}
                    icon={
                        <Icon 
                            name='delete'
                            type='material-icons'
